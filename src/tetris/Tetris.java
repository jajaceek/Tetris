...
public class Tetris extends Application {
    ...
    public void start(Stage stage) {
        ...
        // tworzenie wyniku i info o levelu
        Line line = new Line(XMAX, 0, XMAX, YMAX);
        Text scoretext = new Text("Wynik: ");
        ...
        // tworzenie pierwszej linii i sceny
        Form a = nextObj;
                ...
                Platform.runLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (game) {
                            ...
                            level.setText("Poziom: " + Integer.toString(linesNo));
                        }
                    }
                });
            }
...
//                lines.add(i + lines.size());
    ...
    public void MoveDown(Form form) {
        // przesuwanie na dół jesli linia jest pełna
        if (form.a.getY() == YMAX - SIZE || form.b.getY() == YMAX - SIZE ||
            ...
            // trorzenie nowego klocka i dodawanie go
            Form a = nextObj;
            nextObj = Controller.makeRect();
            object = a;
            groupe.getChildren().addAll(a.a, a.b, a.c, a.d);
        ...
        // przesuwanie jednego klocka na dół jeśli jest miejsce
